    ...
    <view class="container">
        <view class="form-box">
            <view class="form-item">
                ...
                <image v-if="username.length > 0" id="clear-username" class="clear" src="/static/images/clear_input.png" @tap.stop.prevent="clearInput"></image>
            </view>

            <view class="form-item">
                <input class="password" :value="password" password @input="bindPasswordInput" placeholder="密码" />
                <image class="clear" id="clear-password" v-if="password.length > 0" src="/static/images/clear_input.png" @tap.stop.prevent="clearInput"></image>
            </view>

            <view class="form-item">
                <input class="password" :value="confirmPassword" password @input="bindConfirmPasswordInput" placeholder="确认密码" />
                <image class="clear" id="clear-confirm-password" v-if="confirmPassword.length > 0" src="/static/images/clear_input.png" @tap.stop.prevent="clearInput"></image>
            </view>

            <view class="form-item-code">
                <view class="form-item code-item">
                    <input class="code" :value="code" @input="bindCodeInput" placeholder="验证码" />
                    <image class="clear" id="clear-code" v-if="code.length > 0" src="/static/images/clear_input.png" @tap.stop.prevent="clearInput"></image>
                </view>
