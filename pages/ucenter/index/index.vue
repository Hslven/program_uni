    ...
    <view>
        <view class="container">
            <view class="profile-info">
                ...
                <image @tap="onUserInfoClick" class="btn" src="/static/images/address_right.png"></image>
            </view>
        ...
        <view class="dialog-login" v-if="showLoginDialog" @tap="onCloseLoginDialog">
            <view class="dialog-body" @tap.stop.prevent="onDialogBody">
                ...
                <view class="content">
                    ...
                    <button open-type="getUserInfo" lang="zh_CN" @getuserinfo="onWechatLogin">手机号登录</button>
                </view>
            </view>
        </view>
    </view>
